# CONSTITUTION — VisualRegression

Project-specific governance for the **VisualRegression** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
